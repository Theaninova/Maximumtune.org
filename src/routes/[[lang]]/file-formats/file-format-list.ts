...
export const fileFormats: FileFormat[] = [
  ...
  },
  {
    ...
    binary: true,
    compressed: "sometimes",
    kaitai: "/file-formats/kaitai/nut.ksy",
    overrides: [
      {
        title: "XMD Texture Archive",
        extension: ".tex",
        solved: "yes",
        import: "wip",
        export: "no",
        compressed: "yes",
        container: true,
        kaitai: "/file-formats/kaitai/tex.ksy",
      },
    ],
  },
  {
    ...
    overrides: [
      {
        ...
        import: "yes",
        export: "no",
        kaitai: "/file-formats/kaitai/mdl.ksy",
        container: true,
      },
    ],
  },
